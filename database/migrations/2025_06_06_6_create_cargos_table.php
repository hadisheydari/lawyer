...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('cargos', function (Blueprint $table) {
            ...
            $table->timestamp('date_at')->nullable()->comment('تاریخ شروع مناقصه');
        ...
        Schema::create('partitions', function (Blueprint $table) {
            ...
            $table->foreignIdFor(User::class, 'driver_id')->nullable()->comment('راننده ای که این بار رو رزرو کرده')->index()->constrained()->nullOnDelete();
