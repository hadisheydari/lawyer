...
<style>
    ...
    .client-avatar-lg {
        ...
        background: rgba(212,175,55,0.2); border: 3px solid rgba(212,175,55,0.5);
        display: flex; align-items: center; justify-content: center;
        font-size: 2rem; font-weight: 900; color: var(--gold-main); margin: 0 auto 14px;
    }
    ...
    .card-title {
        ...
        margin-bottom: 16px; padding-bottom: 12px; border-bottom: 2px solid #f5f0ea;
    ...
    .upgrade-btn {
        ...
        gap: 8px; transition: 0.2s; margin-top: 14px;
    }
    ...
    .consult-item {
        ...
        gap: 12px; border: 1px solid #f0f0f0; transition: 0.2s;
    }
    ...
    .case-item {
        ...
        border-right: 3px solid var(--gold-main); transition: 0.2s;
    }
    ...
    .case-item .meta {
        font-size: 0.75rem; color: #888; display: flex; gap: 12px; flex-wrap: wrap;
    }
    ...
    @media(max-width: 600px) {
        ...
        .ms-item .n { font-size: 1.1rem; }
        .consult-item { flex-wrap: wrap; gap: 8px; }
                ...
                @foreach($cases as $case)
                    @php
                        $statusMap = [
                            ...
                            'on_hold' => ['l' => 'معلق',    'c' => 'badge-on_hold'],
                            ...
                            <div style="flex:1;min-width:0;">
                                ...
                                <div class="meta">
                                    <span><i class="fas fa-calendar-alt"></i>
                                        {{ \Morilog\Jalali\Jalalian::fromCarbon($case->opened_at ?? $case->created_at)->format('Y/m/d') }}
                                    </span>
                                    <span><i class="fas fa-money-bill-wave"></i> {{ number_format($case->total_fee) }} ت</span>
