...
<style>
    ...
    @media (max-width: 1200px) {
        ...
        .full-page-container { padding: 20px !important; }
    }
</style>
@endpush
        ...
        <div class="article-grid">
                ...
                <div class="card" style="border-right: 8px solid var(--navy) !important;">
                    <div class="card-body">
                        <div style="margin-bottom: 35px;">
                            <label style="display:block; font-weight: 800; color:#475569; margin-bottom:12px;">عنوان مقاله</label>
                            <input type="text" name="title" class="lux-input" placeholder="عنوان مقاله حقوقی خود را اینجا بنویسید..." value="{{ old('title') }}" required>
                        </div>

                        <div style="margin-bottom: 35px;">
                            <label style="display:block; font-weight: 800; color:#475569; margin-bottom:12px;">خلاصه متن (برای پیش‌نمایش)</label>
                            <textarea name="excerpt" class="lux-input" rows="3" placeholder="مختصری از محتوای مقاله...">{{ old('excerpt') }}</textarea>
                        </div>

                        <div>
                            <label style="display:block; font-weight: 800; color:#475569; margin-bottom:12px;">متن اصلی مقاله</label>
            ...
            <div class="sidebar-column">
                <div class="card" style="border-top: 8px solid var(--gold-main) !important;">
                    <div class="card-header"><h3><i class="fas fa-paper-plane"></i> انتشار</h3></div>
                    <div class="card-body">
                        <div style="margin-bottom: 25px;">
                            <label style="display:block; font-weight: 800; color:#475569; margin-bottom:10px;">وضعیت</label>
                        ...
                        <div style="margin-bottom: 30px;">
                            <label style="display:block; font-weight: 800; color:#475569; margin-bottom:10px;">تاریخ (شمسی)</label>
                            <input type="text" class="lux-input persian-datepicker" data-pd-target="publish_date_hidden" placeholder="انتخاب تاریخ...">
                            <input type="hidden" name="published_at" id="publish_date_hidden" value="{{ date('Y-m-d') }}">
                        </div>
                ...
                <div class="card">
                    <div class="card-header"><h3><i class="fas fa-image"></i> تصویر شاخص</h3></div>
                    <div class="card-body">
                        <div style="border: 2px dashed #cbd5e1; border-radius: 15px; padding: 30px 10px; text-align: center; cursor: pointer; background: #f8fafc;" onclick="document.getElementById('thumb_input').click()">
                            <i class="fas fa-camera" style="font-size: 2.5rem; color: var(--gold-main); margin-bottom: 10px; display: block;"></i>
                            <span style="font-size: 0.85rem; font-weight: 800; color: #64748b;">انتخاب تصویر کاور</span>
                ...
                <div class="card">
                    <div class="card-header"><h3><i class="fas fa-tags"></i> برچسب‌ها</h3></div>
                    <div class="card-body">
