...
@section('content')
    <div class="article-page">
        ...
        <div class="page-top">
            ...
            <a href="{{ route('lawyer.articles.index') }}" class="back-link"><i class="fas fa-arrow-right"></i> بازگشت به
                مقالات</a>
        </div>

        @if ($errors->any())
            <div
                style="background:#fef2f2;border:1px solid #fecaca;color:#991b1b;padding:14px 18px;border-radius:10px;margin-bottom:20px;">
            ...
            <div class="article-grid">
                ...
                <div>
                    <div class="card" style="border-right:5px solid var(--navy);">
                        <div class="card-header"><i class="fas fa-align-right"></i>
                            <h3>محتوای مقاله</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header"><i class="fas fa-tags"></i>
                            <h3>دسته‌بندی و برچسب‌ها</h3>
                        </div>
                        <div class="card-body">
                            <div class="two-col">
                                <div class="form-group">
                            ...
                            <x-tag-input name="tags" label="برچسب‌ها" :values="old('tags', [])"
                ...
                <div>
                    <div class="card" style="border-top:5px solid var(--gold-main);">
                        <div class="card-header"><i class="fas fa-paper-plane"></i>
                            <h3>انتشار</h3>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
                    ...
                    <div class="card">
                        <div class="card-header"><i class="fas fa-image"></i>
                            <h3>تصویر شاخص</h3>
                        </div>
                        <div class="card-body">
                            <div class="upload-area" onclick="document.getElementById('thumb_input').click()"
                                id="uploadBox">
