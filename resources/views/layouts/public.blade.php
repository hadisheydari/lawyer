    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-link.active::after {
            ...
            width: 100%; height: 3px; background: var(--gold-main);
        ...
        .nav-login-btn {
            border: 1.5px solid var(--gold-main); color: var(--gold-dark);
        ...
        .nav-logout-btn {
            ...
            background: none; cursor: pointer; font-family: 'Vazirmatn', sans-serif;
        ...
        /* ─── Footer ─────────────────────────────────────────── */
        .footer {
            background-color: #1a1612; color: #888;
            padding: 60px 20px 20px; text-align: center;
            border-top: 4px solid var(--gold-main); margin-top: 80px;
        }
...
/* ─── فرم تماس مدرن (نسخه فلکس‌باکس - بدون باگ) ─── */
        ...
        @media (max-width: 768px) {
            ...
            .nav-menu.open {
                ...
                border-bottom: 2px solid var(--gold-main); gap: 15px;
