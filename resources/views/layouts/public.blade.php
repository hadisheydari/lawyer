    ...
    <header class="header">
        <div class="nav-container">
            ...
            <nav>
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li><a href="{{ route('about') }}"
                            class="nav-link {{ request()->routeIs('lawyers*') ? 'active' : '' }}">درباره وکلا</a></li>
                    ...
                    <li><a href="{{ route(name: 'calculators.index') }}"
                            class="nav-link {{ request()->routeIs('calculators*') ? 'active' : '' }}">ماشین‌حساب
                            حقوقی</a></li>
                    <li><a href="{{ route(name: 'contact') }}"
            ...
            <div class="nav-user-links">
                @auth
                    <a href="{{ route('dashboard.index') }}" class="nav-cta">
