                ...
                <div class="nav-user-links">
                    @auth
                        @if (auth('lawyer')->check())
                            <a href="{{ route('lawyer.dashboard') }}" class="nav-login-btn">پنل وکیل</a>
                        @elseif(auth()->check())
                            <a href="{{ route('dashboard.index') }}" class="nav-login-btn">داشبورد کاربری</a>
                        @endif
                    ...
                    @else
                        <a href="{{ route('login') }}" class="nav-login-btn">ورود / ثبت‌نام</a>
