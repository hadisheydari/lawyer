...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-link {
            font-weight: 600; color: var(--text-body); font-size: 0.95rem;
        ...
        .profile-btn {
            ...
            border: 2px solid var(--gold-main); font-weight: bold;
        ...
        .dropdown-item {
            ...
            color: var(--text-body); transition: 0.2s;
        }
        ...
        .logout-btn {
            display: flex; align-items: center; gap: 10px;
            padding: 12px 16px; font-size: 0.9rem; width: 100%;
            border: none; background: none; cursor: pointer;
            text-align: right; font-family: 'Vazirmatn', sans-serif;
            color: #e74c3c; transition: 0.2s;
        }
