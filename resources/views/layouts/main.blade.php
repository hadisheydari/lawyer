                            ...
                            <div class="flex items-center gap-4">
                                <div class="relative">
                                    <button id="notifBtn" class="relative group hover:text-blue-600 transition">
                                        ...
                                        <span
                                            class="absolute -top-1 -right-1 w-2 h-2 bg-red-500 rounded-full border-2 border-white animate-ping"></span>
                                        <span
                                            class="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition">اعلان‌ها</span>
                                    </button>

                                    <div id="notifDropdown"
                                         class="hidden absolute left-1/2 -translate-x-1/2 mt-3 w-72 max-h-64 overflow-y-auto bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                                ...
                                <button type="button"
                                        ...
                                        class="relative group hover:text-red-500 transition">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="1.8"
                                         viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <span
                                        class="absolute -top-7 left-1/2 -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition">
        خروج
    </span>
                                </button>
                            ...
                            @can('read setting')
                                <li>
                                    ...
                                    <ul id="submenu-1"
                                        ...
                                        <li>
                                            <a href="{{route('cargo_types.index')}}"
                            ...
                            <li>
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                         fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                         stroke-linejoin="round" class="lucide lucide-package2-icon lucide-package-2">
                                        <path d="M12 3v6"/>
                                        <path
