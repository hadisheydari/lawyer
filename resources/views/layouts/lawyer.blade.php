        ...
        <ul class="sidebar-menu">
            ...
            <li class="menu-item" style="margin-bottom: 15px;">
                <a href="{{ route('home') }}" class="menu-link"
                    style="background: rgba(212,175,55,0.1); color: var(--gold-main); border: 1px dashed var(--gold-main);">
            ...
            <li class="menu-item">
                <a href="{{ route('lawyer.comments.index') }}"
                    ...
                    @php $pendingComments = 0;
                        try {
                            $pendingComments = \App\Models\ArticleComment::whereHas('article', fn($q) => $q->where('lawyer_id', auth('lawyer')->id()))->where('status', 'pending')->count();
                        } catch (\Exception $e) {
                    } @endphp
