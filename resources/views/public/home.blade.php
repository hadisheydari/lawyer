...
<style>
    ...
    .hero-content h2::before {
        content: ''; width: 40px; height: 2px; background: var(--gold-main);
    }
    ...
    .hero-content p {
        font-size: 1.05rem; margin-bottom: 40px; max-width: 500px;
        text-align: justify; color: #444; line-height: 1.9;
    }
    .hero-actions { display: flex; gap: 20px; flex-wrap: wrap; }

    /* ─── Hero Visual (دو عکس محرابی) ─────────────────────────────────────── */
    .hero-visual {
        display: flex; justify-content: center; gap: 25px; position: relative;
    }
    ...
    .stats-card::before {
        ...
        height: 4px; background: linear-gradient(90deg, var(--gold-main), var(--gold-dark));
    }
    .stat-item { text-align: center; position: relative; }
    .stat-item:not(:last-child)::after {
        content: ''; position: absolute; left: 0; top: 15%;
        height: 70%; width: 1px; background: rgba(0,0,0,0.05);
    }
    .stat-number {
        display: block; font-size: 2.5rem; font-weight: 800;
        color: var(--text-heading); line-height: 1; margin-bottom: 8px;
    }
    ...
    .section-header h2 {
        font-size: clamp(1.8rem, 3vw, 2.5rem); color: var(--text-heading);
    ...
    .service-card img {
        width: 100%; height: 100%; object-fit: cover;
        transition: transform 0.6s ease; opacity: 0.95;
    }
    ...
    .service-content {
        ...
        align-items: center; padding: 30px; z-index: 2;
    }
    .service-icon {
    ...
    .service-desc {
        ...
        transition: var(--transition); height: 0;
    }
    ...
    .read-more {
        margin-top: auto; color: var(--gold-main); font-weight: 700;
        font-size: 0.9rem; display: inline-flex; align-items: center; gap: 5px; transition: 0.3s;
    }
    ...
    .contact-info-box {
        background-color: var(--text-heading); color: #fff;
        padding: 50px 40px; border-radius: var(--radius-lg);
        position: relative; overflow: hidden; box-shadow: var(--shadow-card);
    }
    .contact-info-box::before {
        content: ''; position: absolute; top: 0; left: 0; right: 0;
        height: 5px; background: linear-gradient(90deg, var(--gold-main), var(--gold-dark));
    }
    ...
    .contact-form-box {
        background: #fdfbf7; padding: 50px;
    ...
    .form-input-c:focus {
        border-color: var(--gold-main); outline: none;
    ...
    .calc-banner-inner::before {
        ...
        font-size: 12rem; color: rgba(207,168,110,0.06);
    ...
    .calc-chip {
        ...
        color: var(--gold-main); padding: 4px 14px; border-radius: 30px;
        ...
        @php
            $services = [
                [
                    ...
                    'title' => 'دعاوی تجاری',
                    'desc'  => 'تنظیم قراردادها، ورشکستگی و وصول مطالبات شرکتی',
                ...
                [
                    'icon'  => 'fas fa-city',
                    'title' => 'املاک و اراضی',
                    'desc'  => 'خلع ید، الزام به تنظیم سند و دعاوی شهرداری',
                ...
                [
                    ...
                    'title' => 'خانواده و ارث',
                    'desc'  => 'طلاق، مهریه، انحصار وراثت و تقسیم ترکه',
                    'img'   => 'https://images.unsplash.com/photo-1609220136736-443140cffec6?auto=format&fit=crop&w=600&q=70',
                    'slug'  => 'family',
                ],
                [
                    'icon'  => 'fas fa-gavel',
                    'title' => 'دعاوی کیفری',
                    'desc'  => 'دفاع در جرایم کلاهبرداری، خیانت در امانت و چک',
                    'img'   => 'https://images.unsplash.com/photo-1589994965851-a8f479c573a9?auto=format&fit=crop&w=600&q=70',
                    'slug'  => 'criminal',
                ],
            ];
        @endphp
        ...
        <div class="contact-form-box">
            ...
            <form action="{{ route('contact') }}" method="POST">
                ...
                <div class="form-group-c">
                    <input type="text" name="name" class="form-input-c"
                           placeholder="نام و نام خانوادگی" required>
                </div>
                <div class="form-group-c">
                    <input type="tel" name="phone" class="form-input-c"
                           placeholder="شماره تماس" required
                           style="direction:ltr;text-align:right;">
                </div>
                <div class="form-group-c">
                    <input type="text" name="subject" class="form-input-c"
                           placeholder="موضوع پرونده">
                </div>
                <div class="form-group-c">
                    <textarea name="message" class="form-input-c"
                              placeholder="شرح مختصر مشکل حقوقی..."></textarea>
                </div>
