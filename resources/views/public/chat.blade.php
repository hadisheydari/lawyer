            ...
            @if (isset($activeConversation))
                ...
                <footer class="chat-footer">
                    <form method="POST" action="{{ route('client.chat.send', $activeConversation->id) }}"
                        style="display:flex;align-items:center;gap:10px;width:100%;" enctype="multipart/form-data">
                        @csrf
                        <div class="input-group">
                            <input type="text" name="message" class="msg-input" placeholder="پیام خود را بنویسید..."
                                autocomplete="off">
