                ...
                <div class="lawyer-sidebar-card">
                    ...
                    <div class="lsc-body">
                        ...
                        <div class="lsc-stats">
                            ...
                            <div class="lsc-stat">
                                <span class="n">+{{ count($lawyer['cases']) }}</span>
                    ...
                    <div class="bio-text">
                        @if($slug === 'babak-abdali')
                            ...
                            <p style="margin-top:16px;">
                                ...
                                رویکرد ایشان همواره بر پایه تحلیل دقیق پرونده، تهیه لوایح مستحکم و حضور فعال در جلسات دادرسی
                                است.
                            </p>
                            <p style="margin-top:16px;">
