    ...
    <div class="auth-container">
                ...
                <form method="POST" action="{{ route('auth.send-otp') }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="tel" name="phone" class="form-input" placeholder="09123456789"
            ...
            <div class="step {{ session('otp_phone') ? 'active' : '' }}" id="stepOtp">
                ...
                <form method="POST" action="{{ route('auth.verify-otp') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="code" class="form-input otp-input" placeholder="_ _ _ _ _ _"
        ...
        <div style="display: flex; flex-direction: column; gap: 10px; margin-top: 20px; align-items: center;">
            ...
            <a href="{{ route('lawyer.login') }}"
                ...
                <i class="fas fa-user-tie" style="color: var(--gold-main); margin-left: 5px;"></i> ورود به پورتال
                اختصاصی وکلا
            </a>

            <a href="{{ route('home') }}" class="home-link" style="margin-top: 5px;">
