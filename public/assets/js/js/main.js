    ...
    jQuery(document).ready(function () {
        ...
        */
        ...
        $backgroundImage.each(function () {
            var $this = $(this), $bgImage = $this.data('bs-bg');
        ...
        $('.ltn__slider-11-active').on('init reInit afterChange', function (event, slick, currentSlide, nextSlide) {
            ...
            responsive: [{
                ...
                breakpoint: 575, settings: {
                    arrows: false, dots: false, slidesToShow: 1, slidesToScroll: 1
                }
            }]
        });
        ...
        $('.ltn__testimonial-slider-3-active').slick({
            ...
            responsive: [{
                ...
                breakpoint: 768, settings: {
                    arrows: false, dots: true, centerMode: false, slidesToShow: 1, slidesToScroll: 1
                }
            }, {
                breakpoint: 580, settings: {
                    arrows: false, dots: true, centerMode: false, slidesToShow: 1, slidesToScroll: 1
        ...
        $('.ltn__testimonial-slider-5-active').slick({
            ...
            responsive: [{
                ...
                breakpoint: 992, settings: {
                    arrows: false, dots: true, centerMode: false, slidesToShow: 2, slidesToScroll: 1
                }
            }, {
                breakpoint: 768, settings: {
                    arrows: false, dots: true, centerMode: false, slidesToShow: 2, slidesToScroll: 1
        ...
        $('.ltn__category-slider-active-six').slick({
            ...
            responsive: [{
                ...
                breakpoint: 992, settings: {
                    arrows: false, dots: true, slidesToShow: 4, slidesToScroll: 1
                }
            }, {
                breakpoint: 768, settings: {
                    arrows: false, dots: true, slidesToShow: 3, slidesToScroll: 1
        ...
        $('.ltn__image-slider-5-active').slick({
            ...
            responsive: [{
                breakpoint: 1600, settings: {
                    slidesToShow: 1, slidesToScroll: 1, centerMode: true, centerPadding: '250px',
                }
            }, {
                breakpoint: 1200, settings: {
                    slidesToShow: 1, slidesToScroll: 1, centerMode: true, centerPadding: '200px',
                }
            }, {
                breakpoint: 992, settings: {
                    arrows: false,
        ...
        $('[data-countdown]').each(function () {
            ...
            if (!$this.hasClass('countdown-full-format')) {
                $this.countdown(finalDate, function (event) {
                    $this.html(event.strftime('<div class="single"><h1>%D</h1><p>روز</p></div> <div class="single"><h1>%H</h1><p>ساعت</p></div> <div class="single"><h1>%M</h1><p>دقیقه</p></div> <div class="single"><h1>%S</h1><p>ثانیه</p></div>'));
                });
            } else {
                $this.countdown(finalDate, function (event) {
                    $this.html(event.strftime('<div class="single"><h1>%Y</h1><p>Years</p></div> <div class="single"><h1>%m</h1><p>ماه</p></div> <div class="single"><h1>%W</h1><p>هفته</p></div> <div class="single"><h1>%d</h1><p>روز</p></div> <div class="single"><h1>%H</h1><p>Hrs</p></div> <div class="single"><h1>%M</h1><p>Mins</p></div> <div class="single"><h1>%S</h1><p>Secs</p></div>'));
                });
            }
