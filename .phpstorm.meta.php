...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/mmdreza/BazargahProject/public/storage',
...
'migrations-generator.migration_template_path','migrations-generator.migration_target_path','migrations-generator.filename_pattern.table','migrations-generator.filename_pattern.view','migrations-generator.filename_pattern.procedure',
'migrations-generator.filename_pattern.foreign_key','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'sanctum.csrf-cookie','generated::4XjxI3719cVh8RlU','generated::PBLatiT2JKlBotDV','login','register',
'verify','loginAction','registerAction','verifyAction','selectRole',
'selectRoleAction','logoutAction','generated::r3WHC387JCYGqLpA','generated::KcLHslIbGPQKoYSr','generated::SyJS8xcavm8OAoOV',
'generated::VHIVFIxhQFVWc3gw','dashboard','companies.index','companies.create','companies.store',
'companies.show','companies.edit','companies.update','companies.destroy','drivers.index',
'drivers.create','drivers.store','drivers.show','drivers.edit','drivers.update',
'drivers.destroy','product-owners.index','product-owners.create','product-owners.store','product-owners.show',
'product-owners.edit','product-owners.update','product-owners.destroy','getCities','storage.local',);
        registerArgumentsSet('views', 
'auth.identity-verification','auth.login','auth.register','auth.role-info','auth.select-role',
'components.form.base-form','components.form.button','components.form.image','components.form.input','components.form.input-password',
'components.form.select-box','components.role-info.company-role','components.role-info.driver-role','components.role-info.product-owner-legal-role','components.role-info.product-owner-real-role',
'dashboard','layouts.auth','layouts.main','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','role_types.normal',
'role_types.large_scale','role_types.real','role_types.legal','role_types.owned','role_types.non_owned',
'roles.admin','roles.user','roles.driver','roles.company','roles.productOwner',
'validation.attributes.email','validation.attributes.password','validation.attributes.name','validation.attributes.username','validation.attributes.national_code',
'validation.attributes.sheba_number','validation.attributes.conditions','validation.attributes.product_owner_type','validation.attributes.company_type','validation.attributes.registration_id',
'validation.attributes.national_id','validation.attributes.rahdari_code','validation.attributes.agent_name','validation.attributes.agent_national_code','validation.attributes.agent_phone_number',
'validation.attributes.manager_name','validation.attributes.manager_national_code','validation.attributes.manager_phone_number','validation.attributes.address','validation.attributes.document',
'validation.attributes.city_id','validation.attributes.birth_date','validation.attributes.father_name','validation.attributes.certificate_number','validation.attributes.property',
'validation.attributes.national_card_file','validation.attributes.smart_card_file','validation.attributes.certificate_file','validation.attributes.company_id','validation.attributes.bank_name',
'validation.attributes.phone','validation.attributes.code',);
