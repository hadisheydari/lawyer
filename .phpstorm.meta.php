...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/mmdreza/BazargahProject/public/storage' => 'string',
            ...
            'services.kavenegar.api_key' => 'string',
...
'app.aliases.Vite','app.market_name','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.links./home/mmdreza/BazargahProject/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.kavenegar.api_key','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'broadcasting.connections.null.driver','view.paths','view.compiled','hashing.driver','hashing.bcrypt.rounds',
'hashing.bcrypt.verify','hashing.bcrypt.limit','hashing.argon.memory','hashing.argon.threads','hashing.argon.time',
'hashing.argon.verify','hashing.rehash_on_login','blade-icons.sets','blade-icons.class','blade-icons.attributes',
'blade-icons.fallback','blade-icons.components.disabled','blade-icons.components.default','migrations-generator.migration_template_path','migrations-generator.migration_target_path',
'migrations-generator.filename_pattern.table','migrations-generator.filename_pattern.view','migrations-generator.filename_pattern.procedure','migrations-generator.filename_pattern.foreign_key','ide-helper.filename',
...
'signed','throttle','verified','role.selected',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','generated::juWpqkB2GUbV3KxF','generated::bL86nnemY28uSZrg','generated::MMzJkk12V2RQvHW5','generated::1JoKCFqUflBwweWC',
'generated::4By4CLP5vWfa7XbH','generated::62CbYMIcQUc0b2F6','generated::ieNThqAcHjO5sdKH','generated::PzDGLSzp8GfdGKU7','login',
'register','verify','loginAction','registerAction','verifyAction',
'selectRole','selectRoleAction','logoutAction','generated::MI7iWD3U6Sp7JuzR','generated::LUcvFH3BQHGH1Ngj',
'generated::nZm2YxSotTD1npjD','generated::oYvZlmKeY7OL3xvY','dashboard','companies.index','companies.create',
'companies.store','companies.show','companies.edit','companies.update','companies.destroy',
'drivers.index','drivers.create','drivers.store','drivers.show','drivers.edit',
'drivers.update','drivers.destroy','product-owners.index','product-owners.create','product-owners.store',
'product-owners.show','product-owners.edit','product-owners.update','product-owners.destroy','packings.index',
'packings.create','packings.store','packings.show','packings.edit','packings.update',
'packings.destroy','vehicle_details.index','vehicle_details.create','vehicle_details.store','vehicle_details.show',
'vehicle_details.edit','vehicle_details.update','vehicle_details.destroy','insurances.index','insurances.create',
'insurances.store','insurances.show','insurances.edit','insurances.update','insurances.destroy',
'cargo_types.index','cargo_types.create','cargo_types.store','cargo_types.show','cargo_types.edit',
'cargo_types.update','cargo_types.destroy','vehicles.index','vehicles.create','vehicles.store',
'vehicles.show','vehicles.edit','vehicles.update','vehicles.destroy','driverManagement',
'allocation','vehicles.detachDriver','cargos.index','cargos.create','cargos.store',
'cargos.show','cargos.edit','cargos.update','cargos.destroy','cargos.type',
'cargo_reservations.create','cargo_reservations.index','cargo_reservations.confirmCargo','cargo_reservations.store','cargo_reservations.show',
'cargo_reservations.edit','cargo_reservations.update','cargo_reservations.destroy','cargo_bids.bid','cargo_bids.set_bid',
'cargo_bids.list_of_bids','cargo_bids.create','cargo_bids.confirmCargo','cargo_bids.index','cargo_bids.store',
'cargo_bids.show','cargo_bids.edit','cargo_bids.update','cargo_bids.destroy','partitions.index',
'partitions.create','partitions.index_of_partition','partitions.edit','partitions.driver','partitions.rate',
'partitions.store','partitions.show','partitions.update','partitions.destroy','getCities',
'getCityScale','storage.local',);
        registerArgumentsSet('views', 
'auth.identity-verification','auth.login','auth.register','auth.role-info','auth.select-role',
'cargo_declaration.cargo_bid.create','cargo_declaration.cargo_bid.edit','cargo_declaration.cargo_bid.index','cargo_declaration.cargo_bid.list_of_bids','cargo_declaration.cargo_bid.set_bid',
'cargo_declaration.cargo_reservations.create','cargo_declaration.cargo_reservations.edit','cargo_declaration.cargo_reservations.index','cargo_declaration.cargos.create','cargo_declaration.cargos.edit',
'cargo_declaration.cargos.index','cargo_declaration.cargos.show','cargo_delivery.partition.create','cargo_delivery.partition.edit','cargo_delivery.partition.index',
'cargo_delivery.partition.index_of_partition','cargo_delivery.partition.show','components.cargo-declaration.cargo','components.cargo-declaration.cargo-bid','components.cargo-declaration.cargo-information',
'components.cargo-declaration.cargo-reservation','components.cargo-delivery.partition','components.cargo-delivery.partition-uploads','components.form.base-form','components.form.button',
'components.form.image','components.form.input','components.form.input-password','components.form.select-box','components.role-info.company-role',
'components.role-info.driver-role','components.role-info.product-owner-legal-role','components.role-info.product-owner-real-role','components.setting.cargo-type','components.setting.insurance',
'components.setting.packing','components.setting.vehicle-detail','components.table.action','components.table.base-table','components.table.cell',
'components.table.row','components.table.status','components.table.thead','components.vehicle.vehicle','dashboard',
'driver_management.index','driver_management.mechanism_allocation','entities.companies.edit','entities.companies.index','entities.companies.show',
'entities.drivers.edit','entities.drivers.index','entities.drivers.show','entities.product-owners.edit','entities.product-owners.index',
'entities.product-owners.show','layouts.auth','layouts.main','setting.cargo-types.create','setting.cargo-types.edit',
'setting.cargo-types.index','setting.cargo-types.show','setting.insurances.create','setting.insurances.edit','setting.insurances.index',
'setting.insurances.show','setting.packings.create','setting.packings.edit','setting.packings.index','setting.packings.show',
'setting.vehicle_details.create','setting.vehicle_details.edit','setting.vehicle_details.index','setting.vehicle_details.show','vehicles.create',
'vehicles.edit','vehicles.index','vehicles.show','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','cargo_enums.fare_type.service',
'cargo_enums.fare_type.tonnage','cargo_enums.cargo_status.free','cargo_enums.cargo_status.reserved','cargo_enums.cargo_status.havale','cargo_enums.cargo_status.barnameh',
'cargo_enums.cargo_status.delivered','cargo_enums.partition_upload.reserved','cargo_enums.partition_upload.havale','cargo_enums.location_type.origin','cargo_enums.location_type.destination',
'cargo_enums.reservation_status.pending','cargo_enums.reservation_status.accepted','cargo_enums.reservation_status.rejected','cargo_enums.type.reserve','cargo_enums.type.rfq',
'cargo_enums.type.free','role_types.normal','role_types.large_scale','role_types.real','role_types.legal',
'role_types.owned','role_types.non_owned','roles.admin','roles.user','roles.driver',
'roles.company','roles.productOwner','validation.attributes.email','validation.attributes.password','validation.attributes.name',
'validation.attributes.username','validation.attributes.national_code','validation.attributes.sheba_number','validation.attributes.conditions','validation.attributes.product_owner_type',
'validation.attributes.company_type','validation.attributes.registration_id','validation.attributes.national_id','validation.attributes.rahdari_code','validation.attributes.agent_name',
'validation.attributes.agent_national_code','validation.attributes.agent_phone_number','validation.attributes.manager_name','validation.attributes.manager_national_code','validation.attributes.manager_phone_number',
'validation.attributes.address','validation.attributes.document','validation.attributes.city_id','validation.attributes.birth_date','validation.attributes.father_name',
'validation.attributes.certificate_number','validation.attributes.property','validation.attributes.national_card_file','validation.attributes.smart_card_file','validation.attributes.certificate_file',
'validation.attributes.company_id','validation.attributes.bank_name','validation.attributes.phone','validation.attributes.code','validation.attributes.province_id',
'validation.attributes.smart_number','validation.attributes.cost_center','validation.attributes.plate_first','validation.attributes.plate_second','validation.attributes.plate_third',
'validation.attributes.plate_letter','validation.attributes.plate_type','validation.attributes.status','validation.attributes.vehicle_detail_id','vehicle_enums.plate_types.general',
'vehicle_enums.plate_types.governmental','vehicle_enums.plate_types.personal','vehicle_enums.status.active','vehicle_enums.status.not_active','vehicle_enums.types.vehicle',
'vehicle_enums.types.trailer','vehicle_enums.plate_letters.الف','vehicle_enums.plate_letters.ب','vehicle_enums.plate_letters.پ','vehicle_enums.plate_letters.ت',
'vehicle_enums.plate_letters.ث','vehicle_enums.plate_letters.ج','vehicle_enums.plate_letters.چ','vehicle_enums.plate_letters.ح','vehicle_enums.plate_letters.خ',
'vehicle_enums.plate_letters.د','vehicle_enums.plate_letters.ذ','vehicle_enums.plate_letters.ر','vehicle_enums.plate_letters.ز','vehicle_enums.plate_letters.ژ',
'vehicle_enums.plate_letters.س','vehicle_enums.plate_letters.ش','vehicle_enums.plate_letters.ص','vehicle_enums.plate_letters.ض','vehicle_enums.plate_letters.ط',
'vehicle_enums.plate_letters.ظ','vehicle_enums.plate_letters.ع','vehicle_enums.plate_letters.غ','vehicle_enums.plate_letters.ف','vehicle_enums.plate_letters.ق',
'vehicle_enums.plate_letters.ک','vehicle_enums.plate_letters.گ','vehicle_enums.plate_letters.ل','vehicle_enums.plate_letters.م','vehicle_enums.plate_letters.ن',
'vehicle_enums.plate_letters.و','vehicle_enums.plate_letters.ه','vehicle_enums.plate_letters.ی',);
...
'KAVENEGAR_API_KEY','BAZARGAH_NAME','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
